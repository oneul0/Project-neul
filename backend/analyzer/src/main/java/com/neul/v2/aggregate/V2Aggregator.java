...
import com.neul.v2.common.dto.AnchorChat;
...
import com.neul.v2.common.dto.V2ContextResult;
...
public class V2Aggregator {
    ...
    @KafkaListener(topics = "v2-raw-chat", groupId = "neul-v2-aggregate-raw-group", containerFactory = "kafkaListenerContainerFactory")
    ...
    @KafkaListener(topics = "v2-troll", groupId = "neul-v2-aggregate-troll-group", containerFactory = "kafkaListenerContainerFactory")
    ...
    @KafkaListener(topics = "v2-context", groupId = "neul-v2-aggregate-context-group", containerFactory = "kafkaListenerContainerFactory")
    ...
    @KafkaListener(topics = "v2-sentiment", groupId = "neul-v2-aggregate-sentiment-group", containerFactory = "kafkaListenerContainerFactory")
