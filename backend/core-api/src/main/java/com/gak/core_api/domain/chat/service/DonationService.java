...
public class DonationService {
    ...
    private static final String KEY_PREFIX = "gak:donations:";
    private static final int MAX_POOL_SIZE = 200;

    @KafkaListener(topics = "donation-events", groupId = "gak-core-api-group", containerFactory = "kafkaListenerContainerFactory")
