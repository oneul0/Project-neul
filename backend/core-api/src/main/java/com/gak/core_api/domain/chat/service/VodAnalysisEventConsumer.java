...
public class VodAnalysisEventConsumer {
    ...
    @KafkaListener(topics = "vod-analysis-complete-topic", groupId = "gak-core-api-vod-status-group")
    ...
    @KafkaListener(topics = "vod-analysis-failed-topic", groupId = "gak-core-api-vod-status-group")
