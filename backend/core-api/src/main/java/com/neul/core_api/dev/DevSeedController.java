 ...
 */
@Slf4j
@ConditionalOnProperty(name = "neul.dev-seed.enabled", havingValue = "true")
@RestController
...
public class DevSeedController {
    ...
    public Mono<ResponseEntity<Map<String, Object>>> seedDonations(
        ...
        String key = "neul:donations:" + channelId;
    ...
    public Mono<ResponseEntity<Map<String, Object>>> getStatus(@PathVariable String channelId) {
        return Mono.zip(
                redisTemplate.opsForList().size("neul:donations:" + channelId).defaultIfEmpty(0L),
